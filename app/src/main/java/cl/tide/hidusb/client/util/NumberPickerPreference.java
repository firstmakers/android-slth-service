...
public class NumberPickerPreference extends DialogPreference {
    ...
    public NumberPickerPreference(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            setMinValue(a.getInteger(R.styleable.NumberPickerDialogPreference_minValue, DEFAULT_MIN_VALUE));
            setMaxValue(a.getInteger(R.styleable.NumberPickerDialogPreference_maxValue, DEFAULT_MAX_VALUE));
        }
        finally
        {
            a.recycle();
